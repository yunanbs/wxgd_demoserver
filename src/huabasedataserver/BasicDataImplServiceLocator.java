...
package huabasedataserver;

public class BasicDataImplServiceLocator extends org.apache.axis.client.Service implements huabasedataserver.BasicDataImplService {
    ...
    private java.lang.String BasicDataImplPort_address = "http://wxcwms.wxmetro.net:80/wxcwpb/webservice/basicdata";
    ...
    public huabasedataserver.IbasicData getBasicDataImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public huabasedataserver.IbasicData getBasicDataImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            huabasedataserver.BasicDataImplServiceSoapBindingStub _stub = new huabasedataserver.BasicDataImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (huabasedataserver.IbasicData.class.isAssignableFrom(serviceEndpointInterface)) {
                huabasedataserver.BasicDataImplServiceSoapBindingStub _stub = new huabasedataserver.BasicDataImplServiceSoapBindingStub(new java.net.URL(BasicDataImplPort_address), this);
                _stub.setPortName(getBasicDataImplPortWSDDServiceName());
                return _stub;
            }
        }
