...
public class GetDataImplServiceLocator extends org.apache.axis.client.Service implements jobserver.GetDataImplService {
    ...
    private java.lang.String GetDataImplPort_address = "http://10.1.13.26:7001/SyncServiceWX/MDM/PS/MDMJobServicePS";
    ...
    public jobserver.IGetData getGetDataImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public jobserver.IGetData getGetDataImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            jobserver.GetDataImplServiceSoapBindingStub _stub = new jobserver.GetDataImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (jobserver.IGetData.class.isAssignableFrom(serviceEndpointInterface)) {
                jobserver.GetDataImplServiceSoapBindingStub _stub = new jobserver.GetDataImplServiceSoapBindingStub(new java.net.URL(GetDataImplPort_address), this);
                _stub.setPortName(getGetDataImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.jobquery.mdms.soft.com/", "GetDataImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.jobquery.mdms.soft.com/", "GetDataImplPort"));
        }
