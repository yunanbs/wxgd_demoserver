...
public class GetDataImplServiceLocator extends org.apache.axis.client.Service implements orgserver.GetDataImplService {
    ...
    private java.lang.String GetDataImplPort_address = "http://10.1.13.26:7001/SyncServiceWX/MDM/PS/MDMOrgServicePS";
    ...
    public orgserver.IGetData getGetDataImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public orgserver.IGetData getGetDataImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            orgserver.GetDataImplServiceSoapBindingStub _stub = new orgserver.GetDataImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (orgserver.IGetData.class.isAssignableFrom(serviceEndpointInterface)) {
                orgserver.GetDataImplServiceSoapBindingStub _stub = new orgserver.GetDataImplServiceSoapBindingStub(new java.net.URL(GetDataImplPort_address), this);
                _stub.setPortName(getGetDataImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://impl.service.orgquery.mdms.soft.com/", "GetDataImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://impl.service.orgquery.mdms.soft.com/", "GetDataImplPort"));
        }
