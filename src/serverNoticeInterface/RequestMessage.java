...
public class RequestMessage  implements java.io.Serializable {
    private serverNoticeInterface.Message message;

    private java.lang.String noun;

    private serverNoticeInterface.User user;
    ...
    public RequestMessage(
           serverNoticeInterface.Message message,
           java.lang.String noun,
           serverNoticeInterface.User user,
     ...
     * @return message
     */
    public serverNoticeInterface.Message getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(serverNoticeInterface.Message message) {
        this.message = message;
    }
     ...
     * @return user
     */
    public serverNoticeInterface.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(serverNoticeInterface.User user) {
        this.user = user;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://localhost:8080/services/NoticeService", "RequestMessage"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("message");
        elemField.setXmlName(new javax.xml.namespace.QName("", "message"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://localhost:8080/services/NoticeService", "Message"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://localhost:8080/services/NoticeService", "User"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
