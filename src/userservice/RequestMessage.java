...
public class RequestMessage  implements java.io.Serializable {
    public userservice.Message message;
     ...
     * @return message
     */
    public userservice.Message getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(userservice.Message message) {
        this.message = message;
    }
     ...
     * @param user
     */
    public void setUser(userservice.User user) {
        this.user = user;
    }
