...
public class RequestMessage  implements java.io.Serializable {
     ...
     * @return message
     */
    public jobserver.Message getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(jobserver.Message message) {
        this.message = message;
    }
     ...
     * @param user
     */
    public void setUser(jobserver.User user) {
        this.user = user;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.jobquery.mdms.soft.com/", "requestMessage"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("message");
        elemField.setXmlName(new javax.xml.namespace.QName("", "message"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://impl.service.jobquery.mdms.soft.com/", "message"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://impl.service.jobquery.mdms.soft.com/", "user"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
