...
public class RequestMessage  implements java.io.Serializable {
    public picserver.Message message;

    public java.lang.String noun;

    public picserver.User user;
     ...
     * @return message
     */
    public picserver.Message getMessage() {
        return message;
    }
     ...
     * @param message
     */
    public void setMessage(picserver.Message message) {
        this.message = message;
    }
     ...
     * @param user
     */
    public void setUser(picserver.User user) {
        this.user = user;
    }
