...
public class GetDataImplServiceLocator extends org.apache.axis.client.Service implements userservice.GetDataImplService {
    ...
    public userservice.IGetData getGetDataImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public userservice.IGetData getGetDataImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            userservice.GetDataImplServiceSoapBindingStub _stub = new userservice.GetDataImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (userservice.IGetData.class.isAssignableFrom(serviceEndpointInterface)) {
                userservice.GetDataImplServiceSoapBindingStub _stub = new userservice.GetDataImplServiceSoapBindingStub(new java.net.URL(GetDataImplPort_address), this);
                _stub.setPortName(getGetDataImplPortWSDDServiceName());
                return _stub;
            }
        }
