...
public class GetDataImplServiceLocator extends org.apache.axis.client.Service implements picserver.GetDataImplService {
    ...
    public picserver.IGetData getGetDataImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public picserver.IGetData getGetDataImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            picserver.GetDataImplServiceSoapBindingStub _stub = new picserver.GetDataImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (picserver.IGetData.class.isAssignableFrom(serviceEndpointInterface)) {
                picserver.GetDataImplServiceSoapBindingStub _stub = new picserver.GetDataImplServiceSoapBindingStub(new java.net.URL(GetDataImplPort_address), this);
                _stub.setPortName(getGetDataImplPortWSDDServiceName());
                return _stub;
            }
        }
