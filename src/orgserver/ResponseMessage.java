...
public class ResponseMessage  implements java.io.Serializable {
    ...
    public orgserver.ErrorMessage errorMessage;

    public orgserver.Result[] result;
    ...
    public ResponseMessage(
           ...
           orgserver.ErrorMessage errorMessage,
           orgserver.Result[] result,
     ...
     * @return errorMessage
     */
    public orgserver.ErrorMessage getErrorMessage() {
        return errorMessage;
    }
     ...
     * @param errorMessage
     */
    public void setErrorMessage(orgserver.ErrorMessage errorMessage) {
        this.errorMessage = errorMessage;
    }
     ...
     * @return result
     */
    public orgserver.Result[] getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(orgserver.Result[] result) {
        this.result = result;
    }

    public orgserver.Result getResult(int i) {
        return this.result[i];
    }

    public void setResult(int i, orgserver.Result _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://impl.service.orgquery.mdms.soft.com/", "responseMessage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://impl.service.orgquery.mdms.soft.com/", "errorMessage"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://impl.service.orgquery.mdms.soft.com/", "result"));
        elemField.setMinOccurs(0);
